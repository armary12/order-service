...
internal class PaymentClientTest {
    ...
    @Test
    fun `isPaymentComplete returns true when response result is true`() {
        ...
        val webClient = WebClient.builder()
            ...
            .build()
        val paymentClient = PaymentClient(webClient)

        // When
        val isComplete = paymentClient.isPaymentComplete(1)
    ...
    @Test
    fun `isPaymentComplete returns false when response result is false`() {
